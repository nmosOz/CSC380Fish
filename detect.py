...
#This is the flag to set when you run this program to send it the video address
parser.add_argument('-i', '--input', help='path to the input video', required=True)

#This is the flag to set the number of consecutiveframes that we want to 
#consider for frame differencing
...
consecutive_grame = args['consecutive_frames']
